document.addEventListener('DOMContentLoaded', () => {
  ...
  const videoData = {
    "Binary02 501z": memberOrder.map(m => `binary02-${m}-501z.mp4`),
    "Binary02 502z": memberOrder.map(m => `binary02-${m}-502z.mp4`),
    "Binary02 503z": memberOrder.map(m => `binary02-${m}-503z.mp4`)
  };
